...
| G1:Exit | EnableBreakeven | true(GOLD) / false(FX,CRYPTO) | 建値移動ON/OFF |
| G1 | BreakevenRR | 1.5(GOLD) / 1.0(FX,CRYPTO) | 建値移動トリガー R:R |
| G1 | ExitMAFastPeriod | 13 | EMAクロス決済Fast |
...
| SLMarginSpreadMult | 1.5 | 1.5 | 1.5 |
