...
//| CRYPTO専用: Level2 Freeze, 0.1% FreezeCancel                      |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Freeze判定: CRYPTO Level2（追従優先型）                             |
//| 更新停止 + 反対色足（内部回帰チェックなし）                            |
//+------------------------------------------------------------------+
bool CheckFreeze()
{
   double open1  = iOpen(Symbol(), PERIOD_M1, 1);
   ...
   // Level2: 更新停止 + 反対色（internal returnなし）
...
//+------------------------------------------------------------------+
//| Freeze取消判定: CRYPTO = Frozen100を0.1%以上更新                     |
//+------------------------------------------------------------------+
bool CheckFreezeCancel()
{
   ...
   // 0.1% threshold based on frozen price
